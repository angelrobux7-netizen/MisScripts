-- // Night Duels #1 - Modified by Manus //
local introShouldPlay = true
local MUSICA_ID = "rbxassetid://76650356472656"
local THEME_ACCENT = Color3.fromRGB(138, 43, 226) -- Purple neón
...
local function playIntroAnimation()
    ...
    local logo = Instance.new("TextLabel", introGui)
    logo.Size = UDim2.new(0, 400, 0, 100)
    logo.Position = UDim2.new(0.5, -200, 0.5, -50)
    logo.BackgroundTransparency = 1
    logo.Text = "NIGHT DUELS #1"
    ...
    local barContainer = Instance.new("Frame", introGui)
    barContainer.Size = UDim2.new(0, 300, 0, 4)
    barContainer.Position = UDim2.new(0.5, -150, 0.5, 60)
    ...
    bar.BackgroundColor3 = THEME_ACCENT
    bar.BorderSizePixel = 0
    bar.ZIndex = 3
    Instance.new("UICorner", bar)

    -- Animation Sequence
    TweenService:Create(bg, TweenInfo.new(1), {BackgroundTransparency = 0.1}):Play()
    task.wait(0.5)
    ...
    task.wait(1)
    TweenService:Create(barContainer, TweenInfo.new(0.5), {BackgroundTransparency = 0}):Play()
    task.wait(0.5)
    TweenService:Create(bar, TweenInfo.new(2, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(1, 0, 1, 0)}):Play()
    task.wait(2.2)
