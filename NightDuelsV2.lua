-- // Night Duels #1 - Custom Intro by Manus //
local INTRO_IMAGE = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663807425969/rCMsLyYCIaGnoJdq.png"
